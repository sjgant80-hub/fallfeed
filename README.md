...
- **Discoverable** — indexed on the FallMarket catalog at [sjgant80-hub.github.io/fallmarket/listing.html?id=fallfeed](https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallfeed)
...
- **Companion SDK** (`npm install @ai-native-solutions/fallfeed-sdk`) — programmatic JavaScript API for direct integration.
- **Companion MCP server** (`claude mcp add fallfeed -- npx -y @ai-native-solutions/fallfeed-mcp`) — Model Context Protocol server that any Claude/Cursor/Codex client can invoke as a tool.
- **Companion HTTP API** (`docker run --rm ghcr.io/sjgant80-hub/fallfeed-api`) — containerized REST endpoint for language-agnostic access.
...
- **Registry entry**: https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallfeed
- **Live URL**: https://sjgant80-hub.github.io/fallfeed/
- **Source**: https://github.com/sjgant80-hub/fallfeed
- **Machine summary**: [llms.txt](llms.txt)
- **License**: MIT
